...
<style>
    ...
    .status-box.success h6 { color: var(--success-color); }
    .status-box.warning h6 { color: var(--warning-color); }
    .status-box.danger h6 { color: var(--danger-color); }
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="taille" 
                                       name="taille" 
                                       value="{{ old('taille', $product->taille) }}" 
                                       data-original="{{ $product->taille }}"
                                       required>
                                @error('taille')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
