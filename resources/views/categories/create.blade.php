...
@section('content')
    <div class="container py-4">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                {{-- En-tête --}}
                <div class="page-header col-lg-12 mb-4 ">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3>{{ isset($category) ? 'Modifier la Catégorie' : 'Nouvelle Catégorie' }}</h3>
                        ...
                        <form
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nom" class="form-control @error('nom') is-invalid @enderror"
                                    ...
                                    placeholder="Ex: Pneus, Électronique, Vêtements..." required>
                                @error('nom')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <input type="color" name="couleur" id="colorPicker"
                                        class="form-control form-control-color"
                                        value="{{ old('couleur', $category->couleur ?? '#6366f1') }}" required>
                                    <input type="text" id="colorValue" class="form-control"
                                        value="{{ old('couleur', $category->couleur ?? '#6366f1') }}" readonly>
                                </div>
                                <small class="text-muted">Choisissez une couleur distinctive pour identifier facilement la
                                    catégorie</small>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="hidden" name="icone" id="selectedIcon"
                                    value="{{ old('icone', $category->icone ?? 'fas fa-box') }}">

                                {{-- Aperçu de l'icône --}}
                                <div class="icon-preview mb-3 text-center p-4 bg-light rounded">
                                    <i id="iconPreview" class="{{ old('icone', $category->icone ?? 'fas fa-box') }} fa-4x"
                                        style="color: {{ old('couleur', $category->couleur ?? '#6366f1') }}"></i>
                                </div>
                                ...
                                <div class="mb-4">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="actif" id="actif"
                                            value="1" {{ old('actif', $category->actif ?? true) ? 'checked' : '' }}>
