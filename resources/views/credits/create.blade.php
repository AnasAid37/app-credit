...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Nouveau Crédit</h1>
                ...
                <div class="border-b border-gray-200 pb-4">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="client_address" 
                                  name="client_address" 
                                  rows="2"
                                  class="w-full px-3 py-2 border @error('client_address') border-red-300 @else border-gray-300 @enderror rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="reason" 
                                  name="reason" 
                                  rows="3"
                                  class="w-full px-3 py-2 border @error('reason') border-red-300 @else border-gray-300 @enderror rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
