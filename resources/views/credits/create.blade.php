                    ...
                    <div class="alert alert-info border-0 shadow-sm mb-4">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <p class="mb-0">
                                    Si un client avec le même nom existe déjà, vous serez redirigé vers sa page
                                    pour éviter les doublons. Assurez-vous d'utiliser le nom exact du client.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('credits.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea id="client_address" name="client_address" rows="3"
                                            class="form-control @error('client_address') is-invalid @enderror" placeholder="Adresse du client (optionnel)">{{ old('client_address') }}</textarea>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="amount" name="amount" step="0.01"
                                                min="0.01" max="999999.99" value="{{ old('amount') }}"
                                        ...
                                        <div class="alert-warning-modern">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div
                                                        style="width: 50px; height: 50px; background: rgba(245, 158, 11, 0.2); border-radius: 0.75rem; display: flex; align-items: center; justify-content: center;">
                                                        <i class="fas fa-wallet"
                                                            style="font-size: 1.5rem; color: var(--warning-color);"></i>
                                                    </div>
                                                    <div>
                                                        <div class="text-muted small fw-500 mb-1">Montant restant à payer
                                                        </div>
                            ...
                            <div class="d-flex justify-content-end gap-2 pt-4 border-top">
                                <a href="{{ route('credits.index') }}" class="btn btn-modern-secondary">
